  ...
  const translations = {
    en: {
      ...
      settings: {
        ...
        modelTurboDetail: "Faster and cheaper. Groq benchmark: 12% word error rate.",
    ...
    zh: {
      ...
      settings: {
        ...
        modelTurboDetail: "更快、更便宜。Groq 官方基准词错误率为 12%。",
        ...
        engine: {
          ...
          gptTranscribe: "GPT Transcribe",
          details: "查看 {model} 详情",
          notReadyKey: "尚未启用。填好 API 密钥后，再点一次 {model} 即可切换。",
