...
- **Customizable Settings**: Configure the engine, API keys, and language

## Requirements

- No account or API key is needed for local transcription. A Groq or OpenAI API key is required only for a cloud provider
