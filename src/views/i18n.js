  ...
  const translations = {
    en: {
      ...
      home: {
        ...
        engineCaptionLocalQwen: "Qwen3-ASR runs locally — audio never leaves this Mac",
      ...
      settings: {
        ...
        engine: {
          ...
          localQwenLarge: {
            name: "Qwen3-ASR 1.7B",
            description: "Experimental: generally higher accuracy, but slower transcription and more memory. Improvement is not guaranteed. Download: about 2.52 GB. Tested peak process memory: about 2.9 GB on M4 / 24 GB RAM; other hardware and recordings vary.",
          },
          localQwen: {
            name: "Qwen3-ASR 0.6B",
    ...
    zh: {
      ...
      home: {
        ...
        engineCaptionLocalQwen: "Qwen3-ASR 在本机运行，音频不离开这台 Mac",
